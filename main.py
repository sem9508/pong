...
ball = Ball(SCREEN_WIDTH/2-STD_BALL_WIDTH/2, SCREEN_HEIGHT/2, STD_BALL_WIDTH, STD_BALL_HEIGHT, STD_MAX_BALL_SPD, STD_ACCELERATION_SPD, RED, STD_BALL_RADIUS, [random.choice([-1, 1]), random.randrange(-100, 100)/100], game_manager, BALL_SPD_INCREMENT)
